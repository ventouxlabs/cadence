...
```json
{"progression": {"id": "dbl-prog-loaded-compound", "type": "double_progression",
                 "rep_min": 8, "rep_max": 12, "load_step_kg": 1.13, "load_step_pct": null,
                 "time_step_s": 10, "distance_step_m": 10, "deload_pct": 0.60,
                 "regress_on": ["hard", "missed", "low_readiness"],
                 "regress_step": 0.10, "regress_reps": 2,
                 "allow_load_progression": false, "cap_load_kg": 5.0},
